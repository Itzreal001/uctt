...
const HARDCODED_PROFILE = {
  ...
  enrolledCourses: [
    {
      code: "BA411",
      name: "Expert Knowledge & Research",
      credits: 4,
      status: "In Progress",
      currentMark: 89,
      progress: 76,
    ...
    {
      code: "BA412",
      name: "Project (Thesis/Dissertation)",
      credits: 6,
      status: "In Progress",
      currentMark: 92,
      progress: 62,
    ...
    {
      code: "BA414",
      name: "Leadership & Corporate Governance",
      credits: 4,
      status: "In Progress",
      currentMark: 88,
      progress: 79,
    ...
    {
      code: "BA416",
      name: "Airline & Transport Management",
      credits: 4,
      status: "In Progress",
      currentMark: 90,
      progress: 75,
    ...
    {
      code: "BA417",
      name: "Public Relations in Tourism",
      credits: 3,
      status: "In Progress",
      currentMark: 87,
      progress: 74,
    ...
    {
      code: "BA421",
      name: "Ethics in Business & Tourism",
      credits: 3,
      status: "In Progress",
      currentMark: 92,
      progress: 84,
